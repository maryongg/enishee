  ...
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="sm:col-span-2 text-center">
      ...
      <div class="flex items-center justify-between sm:col-span-2">
        <button class="inline-block m-auto mt-6 rounded-lg bg-slate-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-slate-300 transition duration-100 hover:bg-slate-600 focus-visible:ring active:bg-slate-700 md:text-base">
