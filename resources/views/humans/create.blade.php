...
<div class="bg-white py-6 sm:py-8 lg:py-12">
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <!-- form - start -->
    <form method="POST" action="{{ route('humans.store') }}" class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" enctype="multipart/form-data">
    @csrf
    ...
    <div class="sm:col-span-2">
      ...
      <div class="sm:col-span-2">
        ...
        <input name="age" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
      </div>

      <div class="sm:col-span-2">
        <label for="job" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">職業</label>
        <input name="job" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
      </div>

      <div class="sm:col-span-2">
        <label for="income" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">年収</label>
        <input name="income" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring" />
      </div>

      <div class="sm:col-span-2">
        <label for="meet" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">出会った手段・場所</label>
        <input name="meet" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring">
      </div>

      <div class="sm:col-span-2">
        <label for="cost" class="mb-2 inline-block text-sm text-gray-800 sm:text-base">デート費用</label>
        <input name="cost" class="w-full rounded border bg-gray-50 px-3 py-2 text-gray-800 outline-none ring-indigo-300 transition duration-100 focus:ring">
      </div>
