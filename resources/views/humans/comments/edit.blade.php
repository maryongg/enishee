<!-- resources/views/humans/comments/edit.blade.php -->
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
          <a href="{{ route('humans.comments.show', [$human, $comment]) }}" class="text-blue-500 hover:text-blue-700 mr-2">詳細に戻る</a>
          <form method="POST" action="{{ route('humans.comments.update', [$human, $comment]) }}">
            @csrf
            @method('PUT')
            <div class="mb-4">
